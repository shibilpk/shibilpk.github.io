...
$(window).scroll(function () {
    if ($('#spotlight .wrapper section.container div.description h1 ').isInViewport()) {
        //  Use #spotlight .wrapper section.container div.description h1 instead of this
        $('#spotlight .wrapper section.container div.description h1').addClass('make-move');
        
    } else {
        //  Remove class
        $('#spotlight .wrapper section.container div.description h1').removeClass('make-move');
